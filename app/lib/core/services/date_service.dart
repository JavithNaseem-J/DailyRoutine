...
class DateService {
  ...
  List<({String abbr, int dayIndex, bool isToday, DateTime date})> buildWeekStrip() {
  ...
  List<({int dateNum, String abbr, bool isToday, DateTime date})> buildWeekStripWithDates() {
    final now = DateTime.now();
    final todayWeekday = now.weekday; // 1=Mon…7=Sun
    final todayIndex = todayWeekday == 7 ? 0 : todayWeekday;
    final labels = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
