...
class ProgressItem {
  ...
  Map<String, dynamic> toJson() =>
      {'id': id, 'name': name, 'progress': progress, 'note': note};
}
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  late List<({int dateNum, String abbr, bool isToday, DateTime date})> _weekStrip;
  ...
  void initState() {
    ...
    _prayerTimer = Timer.periodic(const Duration(seconds: 30), (_) {
      if (mounted) {
        setState(() => _prayerData = prayerService.getPrayerData(DateTime.now()));
      }
    });
  }
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Pre-Plan', style: AppTypography.screenTitle(color: Colors.black)),
            const SizedBox(height: 16),
            TextField(
              controller: ctrl,
              autofocus: true,
              style: AppTypography.body(size: 16, weight: FontWeight.w600, color: Colors.black),
              ...
              children: [
                  ...
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pop(ctx);
                        if (Navigator.canPop(ctx)) Navigator.pop(ctx); // Close viewer if open
                      },
                      child: Text('Delete', style: AppTypography.body(size: 16, weight: FontWeight.w700, color: Colors.black)),
                    ),
                  ),
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Save', style: AppTypography.body(size: 16, weight: FontWeight.w700)),
                  ),
                ),
              ],
            ),
    ...
    showGeneralDialog(
      ...
      pageBuilder: (ctx, anim1, anim2) {
        return Align(
          ...
          child: Container(
            margin: const EdgeInsets.only(top: 210, left: 24, right: 24), // Directly under the date strip
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text('Pre-Plan', style: AppTypography.label(color: Colors.black54)),
                      GestureDetector(
                  ...
                  Text(text, style: AppTypography.body(size: 18, weight: FontWeight.w800, color: Colors.black)),
                  const SizedBox(height: 16),
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: Text('Edit', style: AppTypography.body(size: 14, weight: FontWeight.w700)),
                      style: OutlinedButton.styleFrom(
      ...
      transitionBuilder: (ctx, anim1, anim2, child) {
        return SlideTransition(
          position: Tween<Offset>(begin: const Offset(0, -0.05), end: Offset.zero).animate(anim1),
  ...
  void _loadProgressItems() {
    final raw = sharedPrefs.getString('progress_items_${dateService.todayKey()}');
    if (raw == null) return;
    try {
  ...
  void _updateProgressItem(int i, {String? name, int? progress, String? note}) {
    ...
    _progressDebounce?.cancel();
    _progressDebounce = Timer(const Duration(milliseconds: 400), _saveProgressItems);
  }
  ...
  void _loadQuickTasks() {
    ...
    supabaseService.fetchQuickTasks(dateService.todayKey(), deviceId).then((remote) {
      if (!mounted) return;
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Greeting Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ({String text, IconData icon}) _greetingData(int hour) {
    if (hour >= 4 && hour < 6)   return (text: 'As-salamu alaykum', icon: Icons.nightlight_round);
    if (hour >= 6 && hour < 9)   return (text: 'Good Morning',       icon: Icons.wb_twilight_rounded);
    if (hour >= 9 && hour < 12)  return (text: 'Good Morning',       icon: Icons.wb_sunny_rounded);
    if (hour >= 12 && hour < 15) return (text: 'Good Afternoon',     icon: Icons.light_mode_outlined);
    if (hour >= 15 && hour < 18) return (text: 'Good Afternoon',     icon: Icons.wb_sunny_outlined);
    if (hour >= 18 && hour < 21) return (text: 'Good Evening',       icon: Icons.cloud_outlined);
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(greeting.icon, color: AppColors.textPrimary, size: 20),
                ),
              ...
              Stack(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    height: 36,
                    decoration: BoxDecoration(
                      color: d.isToday ? AppColors.dayActive : Colors.transparent,
                      shape: BoxShape.circle,
                    ),
                    child: Center(
                      child: Text('${d.dateNum}',
                          style: AppTypography.body(
                            size: 13,
...
class _InProgressSection extends StatelessWidget {
  ...
  final void Function(int i, {String? name, int? progress, String? note}) onUpdate;
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = MediaQuery.of(context).size.width * 0.70;
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text('In Progress',
                style: AppTypography.body(size: 20, weight: FontWeight.w800, color: AppColors.textPrimary)),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.rocket_launch_rounded, color: AppColors.textPrimary, size: 20),
                  ),
                  const SizedBox(height: 8),
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle: AppTypography.body(size: 13, color: Colors.black38),
                                        border: InputBorder.none,
                                        isDense: true,
                                        contentPadding: EdgeInsets.zero,
                                      ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          _noteCtrl.text.isEmpty ? 'Task Name' : _noteCtrl.text,
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: AppTypography.body(
                                            size: 16,
                                            weight: FontWeight.w700,
                                            color: _noteCtrl.text.isEmpty ? Colors.black38 : Colors.black,
                                          ),
                                        ),
                                      ),
                                      const SizedBox(width: 10),
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    _nameCtrl.text.isEmpty ? 'Description' : _nameCtrl.text,
                                    maxLines: 2,
                                    overflow: TextOverflow.ellipsis,
                                    style: AppTypography.body(
                                      size: 13,
                                      weight: FontWeight.w500,
                                      color: _nameCtrl.text.isEmpty ? Colors.black26 : Colors.black54,
                                      height: 1.35,
                                    ),
                                  ),
                                ],
              ...
              child: CustomPaint(
                ...
                child: Center(
                  child: AnimatedSwitcher(
                    ...
                    child: value >= 1.0
                        ? Icon(Icons.check_circle_rounded, color: ringColor, size: 32)
                        : Text(
                            valueText,
...
class _ArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (fraction > 0) {
      canvas.drawArc(rect, -1.5708, 6.2832 * fraction, false,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.checklist_rounded, color: Color(0xFF1A1A1A), size: 22),
            const SizedBox(width: 6),
            Text('Task Board',
                style: AppTypography.body(size: 20, weight: FontWeight.w800, color: AppColors.textPrimary)),
          ],
              ...
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    size: 17,
                    color:
                        atLimit ? AppColors.textMuted : Colors.white,
                  ),
                ),
              ),
            ],
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.military_tech_rounded,
                    color: AppColors.complete, size: 20),
                const SizedBox(width: 8),
                Text('All tasks done!',
                    style: AppTypography.body(
                        size: 13,
      ...
      child: ClipRRect(borderRadius: BorderRadius.circular(14), child: Dismissible(
        ...
        background: Container(
          ...
          child: const Icon(Icons.check_circle_rounded,
              color: AppColors.complete, size: 22),
        ),
        secondaryBackground: Container(
          ...
          child: const Icon(Icons.delete_sweep_rounded,
              color: Color(0xFFD44060), size: 22),
        ),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.delete_outline_rounded, size: 20, color: AppColors.textMuted.withValues(alpha: 0.6)),
                  ),
                ),
              ],
            ),
